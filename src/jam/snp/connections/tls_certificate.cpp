...
#include <jam/snp/connections/tls_certificate.hpp>

#include <TODO_qtils/asio_buffer.hpp>
#include <TODO_qtils/macro/make_shared.hpp>
#include <boost/asio/ssl/context.hpp>
#include <jam/snp/connections/alpn.hpp>
#include <jam/snp/connections/config.hpp>
#include <jam/snp/connections/dns_name.hpp>
...
namespace jam::snp {
  ...
  outcome::result<TlsCertificate> TlsCertificate::make(
    ...
    auto secret = ed25519::get_secret(config.keypair);
    ...
    OUTCOME_TRY(DnsName{ed25519::get_public(config.keypair)}.set(x509.get()));
