...
OUTCOME_CPP_DEFINE_CATEGORY(jam::blockchain, BlockTreeError, e) {
  using E = jam::blockchain::BlockTreeError;
  switch (e) {
    case E::NO_PARENT:
    ...
    case E::BLOCK_TREE_CORRUPTED:
      return "block tree corrupted";
    case E::WRONG_WORKFLOW:
      return "trying to use block tree initializing data second time";
  }
