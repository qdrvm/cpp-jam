...
// #include <test-vectors/authorizations/authorizations-types.hpp>
...
namespace jam::authorizations {
  ...
  inline std::pair<types::authorizations::State, types::authorizations::Output> transition(
      const types::Config &config,
      const types::authorizations::State &state,
      const types::authorizations::Input &input) {

    // using Error = types::authorizations::ErrorCode;
    // const auto error = [&](Error error) {
    //   return std::make_pair(state, types::authorizations::Output{error});
    // };
    //
    // // [GP 0.4.5 10.1]
    // // ψ ≡ (ψg, ψb, ψw, ψo)
    ...
    // // ED ≡ (v, c, f)
    //
    // // ED - the authorizations extrinsic
    // const auto &ext = input.authorizations;
    //
    ...
    // return {
    //     state_tick,
    //     types::authorizations::Output{types::authorizations::OutputData{
